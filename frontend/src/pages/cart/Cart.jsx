      ...
      <div className="justify-center max-w-5xl px-6 mx-auto md:flex md:space-x-6 xl:px-0">
        ...
        <div className="h-full p-6 mt-6 bg-white border rounded-lg shadow-md md:mt-0 md:w-1/3">
          ...
          <div className="flex justify-between">
            ...
            <p className="text-lg font-bold">Rs. { totalAmountOfCart }</p>
          </div>
          <button className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600" onClick={()=>navigate("/checkout")}>Check out</button>
        </div>
      </div>
    </div>
  );
